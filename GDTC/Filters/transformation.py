...
def convertSHP2HDF(pipe, file_name):
...
def mergeHDFwithHDF(pipe, file_name1, file_name2):
...
def clipHDFwithSHP(pipe, hdf_file_name, shp_file_name):
...
def clipHDFwithCoordiantes(pipe, hdf_file_name, coord):
